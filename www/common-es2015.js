...
/* harmony import */ var firebase_auth__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! firebase/auth */ 12305);
...
let AuthService = class AuthService {
    ...
    signUp(email, password) {
        ...
        (0,firebase_auth__WEBPACK_IMPORTED_MODULE_0__.createUserWithEmailAndPassword)(auth, email, password)
            .then((userCredential) => {
            // Signed in 
    ...
    signIn(email, password) {
        const auth = (0,firebase_auth__WEBPACK_IMPORTED_MODULE_0__.getAuth)();
        (0,firebase_auth__WEBPACK_IMPORTED_MODULE_0__.signInWithEmailAndPassword)(auth, email, password)
            .then((userCredential) => {
            // Signed in 
            const user = userCredential.user;
